...
<body>
	    ...
	    <article>
			...
			<h4>Yeni Spor Planı Oluştur</h4><br>
			Öğrenci Seç:  <select>
...
<head>
  ...
  <p><label for="ad">Adı:</label>
				<p><label for="soyad">Soyad:</label><br><br>
				Yağ Oranı: <input type="text" style="max-width:100px"><br><br>
				Kilo: <input type="text" style="max-width:100px"><br><br>
				Boy: <input type="text" style="max-width:100px"><br><br>
				<a href="#" class="button buttonS" style="margin-left:80%;">Güncelle</a>
 <br><br><br>
