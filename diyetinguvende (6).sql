...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 07 May 2020, 03:18:27
...
(251, 6, 11, '', 6),
(252, 7, 11, '', 6),
(253, 1, 12, 'pazartesi', 1),
(254, 2, 12, 'salı', 1),
(255, 3, 12, 'çarşamba', 1),
(256, 4, 12, 'perşembe', 1),
(257, 5, 12, 'cuma', 1),
(258, 6, 12, 'cumartesi', 1),
(259, 7, 12, 'pazar', 1),
(260, 1, 12, 'ara öğün', 2),
(261, 2, 12, 'ara öğün', 2),
(262, 3, 12, 'ara öğün', 2),
...
(11, 'Öldürmeyen', 'gğncellencek bir tablo örneği', 3, '2020-05-06'),
(12, 'Diyet Tablosu 2', 'Diyetinize uyun lütfen.', 3, '2020-05-02');

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `diyetyaptimi`
--

CREATE TABLE `diyetyaptimi` (
  `Id` int(11) NOT NULL,
  `tabloId` int(11) NOT NULL,
  `gunId` int(11) NOT NULL,
  `sira` int(11) NOT NULL,
  `yaptiMi` tinyint(1) NOT NULL,
  `kullaniciId` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Tablo döküm verisi `diyetyaptimi`
--

INSERT INTO `diyetyaptimi` (`Id`, `tabloId`, `gunId`, `sira`, `yaptiMi`, `kullaniciId`) VALUES
(53, 12, 3, 2, 1, 37),
(54, 12, 3, 3, 1, 37),
(55, 10, 3, 4, 1, 37),
(56, 10, 4, 6, 1, 37);
...
CREATE TABLE `kullanici` (
  ...
  `pfoto` varchar(100) COLLATE utf8mb4_turkish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_turkish_ci;
...
INSERT INTO `kullanici` (`Id`, `CinsiyetId`, `Ad`, `Soyad`, `DogumTarih`, `KullaniciAdi`, `Email`, `TelefonNo`, `Sifre`, `KullaniciTurId`, `pfoto`) VALUES
(3, 2, 'Server', 'ÇETİN', '2019-12-17', 'server', 'servercetin@hotmail.com', '05434434343', '123', 1, '4510533684.png'),
(5, 2, 'Semih', 'Hatıl', '2019-12-10', 'semih', 'semihhatil@gmail.com', '05551312315', '123', 2, '4644628052.jpg'),
(36, 2, 'Arda', 'ÇEKEM', '2019-12-10', 'arda', 'ardacakem@yahoo.com', '05423123414', '123', 3, ''),
(37, 1, 'Gözde', 'ÇETİNKAYA', '2019-12-12', 'gözde', 'gözde@gmail.com', '05315135219', '123', 3, '3121336412jpeg'),
...
(84, 37, 3, 'merhaba semih', '2020-04-30 22:34:38'),
(85, 37, 3, 'merhaba semih', '2020-04-30 22:34:41'),
(86, 37, 3, 'merhaba semih', '2020-04-30 22:35:44'),
(87, 37, 3, 'merhaba semih', '2020-04-30 22:35:46'),
(88, 37, 3, 'merhaba semih', '2020-04-30 22:35:46'),
(89, 37, 3, '', '2020-04-30 22:35:46'),
(90, 37, 3, '', '2020-04-30 22:35:49'),
(91, 37, 3, '', '2020-04-30 22:35:50'),
(92, 37, 3, '', '2020-04-30 22:35:52'),
(93, 37, 5, 'd', '2020-04-30 22:36:00'),
(94, 37, 5, 'd', '2020-04-30 22:36:04'),
(95, 37, 5, 'd', '2020-04-30 22:36:04'),
(96, 37, 5, '', '2020-04-30 22:36:04'),
(97, 37, 3, 'xdx', '2020-05-04 22:06:08'),
(98, 37, 3, 'asaes', '2020-05-04 22:06:17'),
(99, 37, 3, 'assa', '2020-05-04 22:06:58'),
(100, 37, 5, 'ses', '2020-05-04 22:09:17'),
(101, 37, 3, 'ses', '2020-05-04 22:09:31'),
(102, 3, 36, 'se', '2020-05-04 22:09:56'),
(103, 3, 5, 'ee', '2020-05-04 22:10:03'),
(104, 3, 37, 'ee', '2020-05-04 22:10:12'),
(105, 3, 5, 'aa', '2020-05-04 22:10:25'),
(106, 37, 3, 'se', '2020-05-04 23:50:22'),
(107, 37, 3, 'a', '2020-05-05 17:18:46'),
(108, 37, 5, 'merhaba', '2020-05-06 18:24:15'),
(109, 5, 37, 'merhaba', '2020-05-06 18:24:31'),
(110, 37, 3, 'merhaba', '2020-05-06 20:50:02'),
(111, 37, 5, 'ss', '2020-05-06 20:50:13'),
(112, 37, 5, 'aa', '2020-05-06 20:51:46'),
(113, 37, 5, 'bb', '2020-05-06 21:00:12'),
(114, 5, 36, 'selam', '2020-05-07 00:41:13');
...
(6, 'Spor Planı Gözde', 'Gözde, lütfen sporunu her gün yap. Karantina döneminde sana çok iyi gelicek.', 5, '2020-05-06');

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `sporyaptimi`
--

CREATE TABLE `sporyaptimi` (
  `Id` int(11) NOT NULL,
  `tabloId` int(11) NOT NULL,
  `gunId` int(11) NOT NULL,
  `sira` int(11) NOT NULL,
...
--
-- Tablo döküm verisi `sporyaptimi`
--

INSERT INTO `sporyaptimi` (`Id`, `tabloId`, `gunId`, `sira`, `yaptiMi`, `kullaniciId`) VALUES
(3, 6, 2, 1, 1, 37),
(4, 6, 2, 2, 1, 37),
(5, 6, 3, 3, 1, 37),
(6, 6, 3, 4, 1, 37);
...
--
-- Tablo için indeksler `diyetyaptimi`
--
ALTER TABLE `diyetyaptimi`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `FK_Diyetyaptimi` (`tabloId`),
  ADD KEY `FK_Diyetyaptimi2` (`gunId`),
  ADD KEY `FK_Diyetyaptimi3` (`kullaniciId`);
...
--
-- Tablo için indeksler `sporyaptimi`
--
ALTER TABLE `sporyaptimi`
  ADD PRIMARY KEY (`Id`);
...
--
-- Tablo için AUTO_INCREMENT değeri `diyetyaptimi`
--
ALTER TABLE `diyetyaptimi`
...
--
-- Tablo için AUTO_INCREMENT değeri `sporyaptimi`
--
ALTER TABLE `sporyaptimi`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Tablo kısıtlamaları `diyetyaptimi`
--
ALTER TABLE `diyetyaptimi`
  ADD CONSTRAINT `FK_Diyetyaptimi` FOREIGN KEY (`tabloId`) REFERENCES `diyettablosu` (`Id`),
  ADD CONSTRAINT `FK_Diyetyaptimi2` FOREIGN KEY (`gunId`) REFERENCES `programgun` (`Id`),
  ADD CONSTRAINT `FK_Diyetyaptimi3` FOREIGN KEY (`kullaniciId`) REFERENCES `kullanici` (`Id`);
